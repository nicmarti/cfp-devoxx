...
object ConferenceDescriptor {
  ...
  object ConferenceTracks {
    ...
    val AGILE_DEVOPS = Track("agTest", "agTest.label")
    val CLOUD = Track("cldops", "cldops.label")
    val BIGDATA = Track("bigd", "bigd.label")
  ...
  object ConferenceTracksDescription {
    ...
    val WEB = TrackDesc(ConferenceTracks.MOBILE.id, "/assets/dvfr2015/images/icon_web.png", "track.mw.title", "track.mw.desc")
    ...
    val AGILE_DEVOPS = TrackDesc(ConferenceTracks.AGILE_DEVOPS.id, "/assets/dvfr2015/images/icon_startup.png", "track.agTest.title", "track.agTest.desc")
    val CLOUD = TrackDesc(ConferenceTracks.CLOUD.id, "/assets/dvfr2015/images/icon_cloud.png", "track.cldops.title", "track.cldops.desc")
    val BIGDATA = TrackDesc(ConferenceTracks.BIGDATA.id, "/assets/dvfr2015/images/icon_mobile.png", "track.bigd.title", "track.bigd.desc")
