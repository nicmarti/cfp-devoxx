...
object ConferenceDescriptor {
  ...
  object ConferenceRooms {
    ...
    val allRoomsTIAWed = List(AMPHI_BLEU, NEUILLY_251, PARIS_241, NEUILLY_252AB, PARIS_242AB_T, PARIS_243_T, NEUILLY_253_T)

    val allRoomsTIAThu = List(AMPHI_BLEU, PARIS_242AB_T, NEUILLY_252AB, PARIS_241, NEUILLY_251, PARIS_243_T, NEUILLY_253_T)
    ...
    val allRoomsBOF = List(PARIS_202_203, PARIS_221M_222M, PARIS_224M_225M, NEUILLY_231_232, NEUILLY_234_235)
    ...
    val allRoomsConfFridayNight = List(AMPHI_BLEU, PARIS_242AB_T, NEUILLY_252AB, PARIS_241, NEUILLY_251, PARIS_243_T, NEUILLY_253_T)
  ...
  def current() = ConferenceDescriptor(
    ...
    timing = ConferenceTiming(
      ...
      cfpClosedOn = DateTime.parse("2018-01-14T23:59:00+02:00"),
